...
<div class="row justify-content-center">
  <div class="col-sm-5 grafik">
    <h3 style="font-weight: 550; margin-bottom: 32px;">Jumlah Warga Berdasarkan Jenis Kelamin</h3>
    <canvas id="genderChart" style="margin-bottom: 16px;"></canvas>
  </div>

  <div class="col-sm-1"></div>

  <div class="col-sm-5 grafik">
    <h3 style="font-weight: 550; margin-bottom: 32px;">Jumlah Warga Berdasarkan Usia</h3>
    <canvas id="ageChart" style="margin-bottom: 16px;"></canvas>
  </div>
</div>

<?php $chart = '../../assets/js/chart/dashboard.js' ?>
