...
<form action="store.php" method="post">
  ...
  <table class="table table-striped table-middle">
    <tr>
      ...
      <td width="1%">:</td>
      <td><input type="number" oninput="if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength)" maxlength="16" class="form-control" name="nomor_keluarga" required></td>
    </tr>
    <tr>
  ...
  <table class="table table-striped table-middle">
    ...
    <tr>
      <th>Kecamatan</th>
      <td>:</td>
      <td><input type="text" class="form-control" name="kecamatan_keluarga" value="Lahewa Timur" required></td>
    </tr>
    <tr>
      <th>Kabupaten/Kota</th>
      <td>:</td>
      <td><input type="text" class="form-control" name="kabupaten_kota_keluarga" value="Kabupaten Nias Utara" required></td>
    </tr>
    <tr>
      <th>Provinsi</th>
      <td>:</td>
      <td><input type="text" class="form-control" name="provinsi_keluarga" value="Sumatera Utara" required></td>
    </tr>
    <tr>
      <th>Negara</th>
      <td>:</td>
    ...
    <tr>
      ...
      <td>:</td>
      <td>
        <select name="rt_keluarga" class="form-control">
    ...
    <tr>
      ...
      <td>:</td>
      <td>
        <select name="rw_keluarga" class="form-control">
          <option value="001">001</option>
          <option value="002">002</option>
