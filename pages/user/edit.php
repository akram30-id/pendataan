  ...
  <table class="table table-striped table-middle">
    ...
    <tr>
      ...
      <td>
        ...
        <select class="form-control selectpicker" id="select-role" name="rt_user" required>
          <option value="" selected disabled>- pilih -</option>
          <?php foreach ($selectRT as $rt) { ?>
            <option <?php if ($rt == $data_user[0]['rt_user']) {
                      echo 'selected="selected"';
                    } ?> value="<?= $rt ?>"><?= $rt ?></option>
          <?php } ?>
        </select>
    ...
    <tr>
      ...
      <td>
        ...
        <select class="form-control selectpicker" id="select-role" name="rw_user" required>
          <option value="" selected disabled>- pilih -</option>
          <?php foreach ($selectRW as $rw) { ?>
            <option <?php if ($rw == $data_user[0]['rw_user']) {
                      echo 'selected="selected"';
                    } ?> value="<?= $rw ?>"><?= $rw ?></option>
          <?php } ?>
        </select>
